        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="images/tocuri.jpeg" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/geanta1.png" alt="Dummy Image" /></li>
                    <li><img class="img-responsive" src="images/geanta2.png" alt="Dummy Image" /></li>
                </ul>
...
<%--                        <a href="#" class="btn-prev">Prev</a> <a href="#" class="btn-play">Start</a> <a href="#"--%>
<%--                                                                              class="btn-pause">Pause <a href="#" class="btn-next">Next</a>--%>
<%--                    </div>--%>
<%--                </div>--%>
                <div class="clearfix"></div>
            </div>
                        ...
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <input type="hidden" name="productId"
                                       ...
                                       src="images/<%=retriveProduct.getString("image_name")%>"
                            ...
                            <div class="item-info-product ">
                                ...
                                <div class="info-product-price">
                                    <input type="hidden" name="price"
                                           ...
                                           class="item_price"><%=retriveProduct.getString("price")%> RON</span>
                                    <del><%=retriveProduct.getString("mrp_price")%> RON</del>
                                </div>
