                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr class="rem1">
                            ...
                            <td class="invert"><del><%=totalProduct.getString(4)%>&nbsp;RON.
                                </del></td>
                            <td class="invert"><%=totalProduct.getString(5)%>&nbsp;RON.</td>
                            <td class="invert"><%=totalProduct.getString(6)%>&nbsp;RON.</td>
                            <td class="invert"><a
