...
public class AddProducts extends HttpServlet {
    ...
    private final String UPLOAD_DIRECTORY = "C:\\Users\\Gia\\OneDrive\\Desktop\\OnlineShoppingSystem\\web\\images";
    @Override
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
                ...
                try {
                    ...
                    // make sure path is correctly escaped when inserted to the db
